...
#ifndef IDLE_CORE_VIEWS_HPP_INCLUDED
#define IDLE_CORE_VIEWS_HPP_INCLUDED

#include <idle/core/views/addressof.hpp>
#include <idle/core/views/cast.hpp>
...
#include <idle/core/views/stop.hpp>
#include <idle/core/views/transform.hpp>

#endif // IDLE_CORE_VIEWS_HPP_INCLUDED
