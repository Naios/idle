...
#ifndef IDLE_EXTRA_GRAPHVIZ_HPP_INCLUDED
#define IDLE_EXTRA_GRAPHVIZ_HPP_INCLUDED
...
/// Prints the graph in the graphviz format (".dot")
IDLE_API(idle)
void graphviz(std::ostream& os, DependencyGraph const& graph);
/// Prints the reverse graph in the graphviz format (".dot")
IDLE_API(idle)
...
#endif // IDLE_EXTRA_GRAPHVIZ_HPP_INCLUDED
